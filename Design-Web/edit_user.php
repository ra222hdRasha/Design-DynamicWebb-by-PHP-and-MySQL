...
//This page is for editing user record
//This page is accessed through view_users.php
 ...
 echo '<h1>Edit a User</h1>';
   ...
   //Check for a a valid user ID, through GET or POST:
   if((isset($_GET['id'])) &&(is_numeric($_GET['id'])) ){ //From view_users.php
    $id = $_GET['id'];
   } elseif ((isset($_POST['id'])) && (is_numeric($_POST['id']))) { //From submission
     $id = $_POST['id'];
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
   ...
   if(empty($errors)) { //If every things are OK!.
